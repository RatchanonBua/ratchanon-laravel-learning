...
<template>
  <main class="p-6">
    <section class="bg-white dark:bg-gray-900">
      <div class="py-8 pt-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-sm text-center">
          <h1 class="mb-4 text-7xl tracking-tight font-extrabold lg:text-9xl text-primary-600 dark:texst-primary-500">404</h1>
